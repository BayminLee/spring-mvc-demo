...
function dhtmlXTabBar(a, b, c) {
	...
	this._s.line_height = (parseInt(c) || 30);
	this._s.skin_line = 1;
...
dhtmlXTabBar.prototype = {
	...
	_setSizes: function(a, b) {
		...
		var d = _isIE && document.compatMode == "BackCompat",
			...
			g = this._rows.length * this._s.line_height + (this._s.skin_line_x ? 1 : 0);
		this._tabZone.style[this._dy] = g + this._s.skin_line + "px";
	...
	_setRowSizes: function() {
		for(var a = 0; a < this._rows.length; a++) this._rows[a].style[this._dy] = this._s.line_height + this._s.skin_line + "px", this._rows[a].style[this._py] = a * (this._s.line_height - (this._s.skin_line_x ?
	...
	_createTab: function(a, b, c) {
		...
		var e = "<span>" + b + "</span><div style='display:none;'></div><div style='display:none;'></div><div style='display:none;'></div>";
		...
		d.style[this._dy] = this._s.line_height-3 + "px";
	...
	_getCoverLine: function() {
		if(!this._lineA) this._lineA = document.createElement("div"), this._lineA.className = "dhx_tablist_line", this._lineA.style[this._py] =
			this._s.line_height + (this._s.skin_line_x ? 1 : 0) + "px", this._lineA.style[this._dx] = "100%", this._lineA._index = 1;
